...
public class BrickShopItem extends ShopItem<BuildingShopKeeper> {
    ...
    public BrickShopItem(final BuildingShopKeeper module) {
        super(module, new ItemStack(Material.BRICK));
    }
