...
public class DiamondLeggingsShopItem extends ShopItem<ArmourShopKeeper> {
    ...
    public DiamondLeggingsShopItem(final ArmourShopKeeper module) {
        super(module, new ItemStack(Material.DIAMOND_LEGGINGS));
    }
