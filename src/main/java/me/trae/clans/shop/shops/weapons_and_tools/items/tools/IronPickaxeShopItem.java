...
public class IronPickaxeShopItem extends ShopItem<WeaponsAndToolsShopKeeper> {
    ...
    public IronPickaxeShopItem(final WeaponsAndToolsShopKeeper module) {
        super(module, new ItemStack(Material.IRON_PICKAXE));
    }
