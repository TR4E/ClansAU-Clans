...
public class EmeraldBlockShopItem extends ShopItem<ResourcesShopKeeper> {
    ...
    public EmeraldBlockShopItem(final ResourcesShopKeeper module) {
        super(module, new ItemStack(Material.EMERALD_BLOCK));
    }
