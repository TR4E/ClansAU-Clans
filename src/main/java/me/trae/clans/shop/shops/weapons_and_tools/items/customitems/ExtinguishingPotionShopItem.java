...
public class ExtinguishingPotionShopItem extends CustomItemShopItem<WeaponsAndToolsShopKeeper> {
    ...
    public ExtinguishingPotionShopItem(final WeaponsAndToolsShopKeeper module) {
        super(module, WeaponRegistry.getWeaponByName("ExtinguishingPotion"));
    }
