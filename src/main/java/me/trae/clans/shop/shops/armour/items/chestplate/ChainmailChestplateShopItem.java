...
public class ChainmailChestplateShopItem extends ShopItem<ArmourShopKeeper> {
    ...
    public ChainmailChestplateShopItem(final ArmourShopKeeper module) {
        super(module, new ItemStack(Material.CHAINMAIL_CHESTPLATE));
    }
