...
public class RedstoneBlockShopItem extends ShopItem<ResourcesShopKeeper> {
    ...
    public RedstoneBlockShopItem(final ResourcesShopKeeper module) {
        super(module, new ItemStack(Material.REDSTONE_BLOCK));
    }
