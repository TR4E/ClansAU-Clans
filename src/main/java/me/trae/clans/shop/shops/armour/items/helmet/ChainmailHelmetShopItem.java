...
public class ChainmailHelmetShopItem extends ShopItem<ArmourShopKeeper> {
    ...
    public ChainmailHelmetShopItem(final ArmourShopKeeper module) {
        super(module, new ItemStack(Material.CHAINMAIL_HELMET));
    }
