...
public class KillRangers extends Quest implements KillQuest<Player> {

    public KillRangers(final QuestManager manager) {
        super(manager);
    }
    ...
    public boolean canKill(final Player killer, final Player entity) {
        return UtilServer.getEvent(new RoleCheckEvent(entity)).getRole().getName().equals("Rangers");
    }
}