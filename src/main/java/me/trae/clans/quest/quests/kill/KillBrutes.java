...
public class KillBrutes extends Quest implements KillQuest<Player> {

    public KillBrutes(final QuestManager manager) {
        super(manager);
    }
    ...
    public boolean canKill(final Player killer, final Player entity) {
        return UtilServer.getEvent(new RoleCheckEvent(entity)).getRole().getName().equals("Brute");
    }
}