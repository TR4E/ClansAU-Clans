...
public class DisableSlimeBlockRecipe extends SpigotListener<Clans, RecipeManager> implements DisableRecipeContainer {

    public DisableSlimeBlockRecipe(final RecipeManager manager) {
        super(manager);
    }
