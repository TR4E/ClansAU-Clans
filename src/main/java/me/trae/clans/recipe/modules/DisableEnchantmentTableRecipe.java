...
public class DisableEnchantmentTableRecipe extends SpigotListener<Clans, RecipeManager> implements DisableRecipeContainer {

    public DisableEnchantmentTableRecipe(final RecipeManager manager) {
        super(manager);
    }
